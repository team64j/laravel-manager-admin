...
.app-tabs-navigation button {
  @apply flex items-center justify-center m-0.5 h-10 relative shrink-0 cursor-pointer whitespace-nowrap rounded select-none border-0 ring-0 text-center font-medium bg-transparent hover:bg-gray-100/50 dark:hover:bg-gray-600/40 dark:hover:text-white transition
}
